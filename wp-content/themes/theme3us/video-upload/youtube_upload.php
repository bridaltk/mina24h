...
if(isset($_REQUEST['videoSubmit'])){
	...
	if($_REQUEST['videoFile'] != ''){
		$videoFilePath = $_REQUEST['videoFile'];
...
if ($client->getAccessToken()) {
  try{
    ...
    $htmlBody .= '</ul>';
	$htmlBody .= '<a href="logout.php?id=' . $_SESSION['post_id'] . '">Logout</a>';
	...
	$htmlBody .= 'Please reset session <a href="logout.php?id=' . $_SESSION['post_id'] . '">Logout</a>';
  }
